      ...
      <div className="container mt-5 ">
        {loading ? (
          ...
          <div className="border border-5 p-4  mb-4 bg-warning-subtle">
            <h1 className="mb-4 display-8 fw-bold text-dark">Jnana Library Manager : Add, Delete, or Update Books</h1>
            <div className="row">
                ...
                <div className="card">
                  ...
                  <div className="card-body d-flex flex-column align-items-center">
                    <div className="card-buttons mb-3">
                      <button
                        className={`btn ${option === "add" ? "btn-success" : "btn-info"}`}
                        onClick={() => handleOptionChange("add")}
                      >
                        Add Book
                      </button>
                      <button
                        className={`btn ${option === "delete" ? "btn-primary" : "btn-warning"}`}
                    ...
                    <div className="book-card">
                      <img
                        src="https://images.pexels.com/photos/3646172/pexels-photo-3646172.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                        alt="Book Options"
                        className="img-fluid"
              ...
              <div className="col-md-8">
                <div className="border border-5 p-4 bg-info">
                  <div className="card ">
              ...
              <div className="border border-5 mt-3 p-4 bg-warning">
