...
import AWAT from '../Images/CivilEngineering.jpg';
import BHAA from '../Images/maths.jpg';
import Bheth from '../Images/airship.jpg';
...
function Home() {
  ...
  const generateCards = () => {
    const cardData = [
      { imageUrl: AWAT,          title: 'Civil Engineering',    text: 'Embark on a literary journey with this captivating tale of adventure and discovery.' },
      { imageUrl: BHAA,          title: 'maths',    text: 'Explore the complexities of love and relationships in this heartwarming novel.' },
  ...
  <div>
    ...
    <div className="text-center bg-light p-4 rounded shadow">
      <div className="text-danger display-6 font-weight-bold" style={{ textShadow: '2px 2px 2px rgba(255, 140, 120, 0.8)' }}>
        Welcome to Jnana Library Management.
      </div>
    </div>
