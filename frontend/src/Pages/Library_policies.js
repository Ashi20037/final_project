  ...
  return (
    <div>
      ...
      <div className="container mt-5 ">
        <h1 className="text-warning">Library Policies</h1>

        <div className="parallax text-info p-4 rounded shadow">
        ...
        <div className="parallax text-info p-4 mt-4 rounded shadow">
        ...
        <div className="parallax3 text-info  p-4 mt-4 mb-3 rounded shadow ">
